    ...
    if (tr == bl && tr == br) {
        ...
        *color = bl;
        ...
        r = (2 + gdImageRed(im, tl) + gdImageRed(im, tr) + gdImageRed(im, bl) +
             gdImageRed(im, br)) /
            4;
        g = (2 + gdImageGreen(im, tl) + gdImageGreen(im, tr) + gdImageGreen(im, bl) +
             gdImageGreen(im, br)) /
            4;
        b = (2 + gdImageBlue(im, tl) + gdImageBlue(im, tr) + gdImageBlue(im, bl) +
             gdImageBlue(im, br)) /
            4;
        a = (2 + gdImageAlpha(im, tl) + gdImageAlpha(im, tr) + gdImageAlpha(im, bl) +
             gdImageAlpha(im, br)) /
            4;
