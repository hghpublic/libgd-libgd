...
/** \file gd_io_stream.h
   ...
   std::ios_base::binary ); ostreamIOCtx _out_ctx(out); gdImageGifCtx(im_in, &
   _out_ctx);
                }
...
class BGD_EXPORT_DATA_IMPL istreamIOCtx : public gdIOCtx {
  public:
    ...
    */
    istreamIOCtx(stream_type &__stream) { init(&__stream); }
 ...
 */
inline gdIOCtxPtr gdNewIstreamCtx(std::istream *__stream) { return new istreamIOCtx(*__stream); }
...
class BGD_EXPORT_DATA_IMPL ostreamIOCtx : public gdIOCtx {
  public:
    ...
    /** Construct an instance of this output stream specialization,
            ...
            For example:
            std::ofstream out("image.gif", std::ios_base::out |
       std::ios_base::binary ); ostreamIOCtx out_ctx(out);
    */
    ostreamIOCtx(stream_type &__stream) { init(&__stream); }
...
/** Allocate a new instance of the class
 */
inline gdIOCtxPtr gdNewOstreamCtx(std::ostream *__stream) { return new ostreamIOCtx(*__stream); }
