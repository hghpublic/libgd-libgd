...
int main(int argc, char *argv[])
{
    ...
    gdImageStringFT(im, 0, blue, "arial", 12, 0, 20, 20, "plain pathname default");
    /* Specifically opt for fontconfig */
    se.flags = gdFTEX_FONTCONFIG;
    gdImageStringFTEx(im, 0, blue, "arial:bold", 12, 0, 20, 40, "fontconfig arial:bold", &se);
    ...
    gdImageStringFT(im, 0, blue, "arial:bold", 12, 0, 20, 60, "fontconfig arial:bold default");
    /* Explicitly use a pathname despite fontconfig default */
    se.flags = gdFTEX_FONTPATHNAME;
    gdImageStringFTEx(im, 0, blue, "arial", 12, 0, 20, 80, "plain pathname", &se);
#ifdef HAVE_LIBPNG
